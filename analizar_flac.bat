...
set "OPCION_AUCDTECT="
if exist "%~dp0aucdtect.exe" set "OPCION_AUCDTECT=--aucdtect "%~dp0aucdtect.exe""
...
if defined OPCION_AUCDTECT echo con segunda opinion de auCDtect
echo.

rem ── argumentos extra del BAT se pasan tal cual (--solo-malos, --detalle, --hilos N...) ──
python "%SCRIPT%" "%CARPETA%" --csv "%CSV%" %OPCION_AUCDTECT% %2 %3 %4 %5 %6 %7 %8 %9
